        ...
        if (d.isBreaking) {
          ...
          el.innerHTML = `
            <div class="relative group cursor-pointer animate-pulse-slow">
              <div class="absolute -inset-2 rounded-full ${isM ? 'hidden' : 'blur-sm opacity-50 transition-opacity group-hover:opacity-100'}" style="background-color: #${d.avatarBg || '10b981'}"></div>
